...
title: 你不需要會寫程式，也能製作 Discord 音樂機器人【猴子都能懂的 Discord 教學】
authors: kane
description: "我知道光是要學會寫程式就是件很困難的事情對了吧，那你還不點進來看一下這篇？今天的教學是給完全 0 基礎，但是又很嚮往能夠製作出自己的機器人的人，本篇使用 JMusicBot 建造自己的音樂機器人"
tags:
  [
    "Discord",
    "dc",
...
今天的教學是給完全 0 基礎， 但是又很嚮往能夠有自己的音樂機器人的人，
有問題也請到 [我的伺服器](https://discord.gg/ct2ufag) 來問問題。

## YEE式機器龍？

[YEE式機器龍](https://yeecord.com) 是我寫程式這一路走來最大、也最具意義的作品，當然我現在也會拿它來聽音樂，
...
首先先啟動一次 JAR 檔案讓它生出 `config.txt` 讓我們設定，
